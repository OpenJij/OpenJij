...
TEST(System, IsingPolynomialSystemSeed) {
   ...
   EXPECT_NO_THROW(sa_system.Flip(3, sa_system.GenerateCandidateState(3)));
   EXPECT_NO_THROW(sa_system.Flip(4, sa_system.GenerateCandidateState(4)));
...
TEST(System, IsingPolynomialSystemExplicitLinearQuad) {
   ...
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(0, -1), -6.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(1, -1), -7.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(2, -1), -1.0);
   sa_system.Flip(0, sa_system.GenerateCandidateState(0));
   EXPECT_EQ(sa_system.GetBaseEnergyDifference().size(), 3);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(0, +1), +6.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(1, -1), +5.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(2, -1), -5.0);
   sa_system.Flip(0, sa_system.GenerateCandidateState(0));
   EXPECT_EQ(sa_system.GetBaseEnergyDifference().size(), 3);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(0, -1), -6.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(1, -1), -7.0);
   ...
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(0, -1), +6.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(1, +1), +7.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(2, -1), -7.0);
   sa_system.Flip(1, sa_system.GenerateCandidateState(1));
   EXPECT_EQ(sa_system.GetBaseEnergyDifference().size(), 3);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(0, -1), -6.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(1, -1), -7.0);
   ...
   EXPECT_EQ(sa_system.GetBaseEnergyDifference().size(), 3);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(0, -1), -10.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(1, -1), -13.0);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(2, +1), +1.0);
   sa_system.Flip(2, sa_system.GenerateCandidateState(2));
   EXPECT_EQ(sa_system.GetBaseEnergyDifference().size(), 3);
   EXPECT_DOUBLE_EQ(sa_system.GetEnergyDifference(0, -1), -6.0);
