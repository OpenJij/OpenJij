    ...
    namespace cuda {
      ...
      #define HANDLE_ERROR_CUDA( expr )                                                                                     \
        {                                                                                                                   \
          ...
          if ( err != cudaSuccess )                                                                                         \
            std::cerr << "cuda error_code: " << err << " err_name: " << cudaGetErrorString( err ) << " at " << __FILE__     \
      ...
      #define HANDLE_ERROR_CURAND( expr )                                                                                   \
        {                                                                                                                   \
          ...
          if ( st != CURAND_STATUS_SUCCESS )                                                                                \
            std::cerr << "curand_error: " << st << " at " << __FILE__ << " line " << __LINE__ << std::endl;                 \
        }
    #endif
      ...
      #define HANDLE_ERROR_CUBLAS( expr )                                                                                   \
        {                                                                                                                   \
          ...
          if ( st != CUBLAS_STATUS_SUCCESS )                                                                                \
            std::cerr << "cublas_error: " << st << " at " << __FILE__ << " line " << __LINE__ << std::endl;                 \
        }
    #endif
