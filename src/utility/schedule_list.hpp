...
namespace openjij {
  namespace utility {
    ...
    make_classical_schedule_list( double beta_min, double beta_max, std::size_t one_mc_step, std::size_t num_call_updater ) {
    ...
    /**
     * @brief helper function for making transverse field system schedule list with arithmetic sequence of annealing schedule
     * (s)
     *
    ...
    make_transverse_field_schedule_list( double beta, std::size_t one_mc_step, std::size_t num_call_updater ) {
    ...
    /**
     * @brief helper function for making classical constraint schedule list with geometric series of inverse temperatures
     * (with constraint parameter fixed).
     *
    ...
    ScheduleList<SystemType> make_schedule_list(
        const std::vector<std::pair<typename UpdaterParameter<SystemType>::Tuple, std::size_t>>& tuplelist ) {
