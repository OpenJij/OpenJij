...
namespace openjij {
  namespace utility {
    ...
    namespace cuda {
      ...
      curand_generate_uniform_impl<float>( curandGenerator_t generator, float *outputPtr, size_t num ) {
        return curandGenerateUniform( generator, outputPtr, num );
      }

      template<>
      inline curandStatus_t
      curand_generate_uniform_impl<double>( curandGenerator_t generator, double *outputPtr, size_t num ) {
