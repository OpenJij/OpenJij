...
namespace openjij {
  namespace system {
     ...
     */
    template<typename FloatType, std::size_t rows_per_block = 2, std::size_t cols_per_block = 2>
     ...
     * @return
     */
    template<std::size_t rows_per_block = 2, std::size_t cols_per_block = 2, typename FloatType>
