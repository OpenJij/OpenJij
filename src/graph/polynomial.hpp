...
#pragma omp parallel for
      ...
      //! @details Note that the input argument "key" will be sorted. If the interaction specified by "key" is empty, the
      //! zero will be added to the polynomial graph.
      ...
      //! @details Note that the input argument "key" will be sorted. If the interaction specified by "key" is empty, this
      //! function returns the zero.
      //! @param key std::vector<Index>&
      //! @return The interaction corresponding to "key".
...
#pragma omp parallel for reduction( + : energy )
    ...
    private:
      //! @brief The list of the indices of the polynomial interactions (namely, the list of key of the polynomial
      //! interactions as std::unordered_map) as std::vector<std::vector<Index>>.
      cimod::PolynomialKeyList<Index> poly_key_list_;

      //! @brief The list of the values of the polynomial interactions (namely, the list of value of the polynomial
      //! interactions as std::unordered_map) as std::vecto<FloatType>.
