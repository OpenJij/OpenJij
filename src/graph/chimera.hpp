        ...
        template<typename FloatType=double>
            class Chimera : public Sparse<FloatType>{
                ...
                private:
                     ...
                     */
                    constexpr static size_t _num_in_chimera = 8;
                ...
                public:
                    ...
                    Index to_ind(int64_t r, int64_t c, int64_t i) const{
                        ...
                        assert(0 <= i && i < (int64_t)_num_in_chimera);
                    ...
                    ChimeraIndex to_rci(Index ind) const{
                        ...
                        int64_t r = ind/(_num_column*_num_in_chimera);
                        ind -= (_num_column*_num_in_chimera)*r;
                        int64_t c = ind/_num_in_chimera;
                        ...
                        : Sparse<FloatType>(num_row*num_column*_num_in_chimera, 6+1), _init_val(init_val), _num_row(num_row), _num_column(num_column){
                            ...
                            for(size_t r=0; r<_num_row; r++){
                                for(size_t c=0; c<_num_column; c++){
                                    for(size_t i=0; i<_num_in_chimera; i++){
                                        //open boundary
                                        if(r > 0 && i < 4){
                                            //MINUS_R (0<=i<4)
                     ...
                     */
                    size_t get_num_row() const{return _num_row;}
                     ...
                     */
                    size_t get_num_column() const{return _num_column;}
                     ...
                     */
                    size_t get_num_in_chimera() const{return _num_in_chimera;}
